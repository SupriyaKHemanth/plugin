...
var ConnectedList = function ConnectedList(_ref) {
    ...
    return _react2.default.createElement(
        ...
        articles.map(function (el) {
            return _react2.default.createElement(
                'li',
                { className: 'list-group-item', key: el.id },
                el.title
            );
        })
    );
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(13), __webpack_require__(35)(module)))
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // src/js/components/Form.js
...
ConnectedForm.propTypes = {
    addArticle: _propTypes2.default.func.isRequired
};
...
var _action_types = __webpack_require__(20);

var addArticle = exports.addArticle = function addArticle(article) {
  return { type: _action_types.ADD_ARTICLE, payload: article };
...
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; // src/js/reducers/index.js
...
var rootReducer = function rootReducer() {
    ...
    switch (action.type) {
        case _action_types.ADD_ARTICLE:
